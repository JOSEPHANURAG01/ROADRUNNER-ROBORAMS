...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "left_front_drive")); //parallel
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "right_front_drive"));
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "right_back_drive")); //perpen
